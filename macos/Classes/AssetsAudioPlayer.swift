...
public class Player : NSObject, AVAudioPlayerDelegate {
    ...
    func open(assetPath: String, autoStart: Bool, result: FlutterResult){
                ...
                let folder = assetUrl.deletingLastPathComponent().path
                ...
                guard let path = Bundle.main.path(forResource: fileName, ofType: nil, inDirectory: "flutter_assets") else {
               ...
               // guard let url = Bundle.main.url(forResource: fileName, withExtension: "", inDirectory: "flutter_assets") else {
               //             log("resource not found "+assetPath)
               //             result("");
               //             return
               // }
